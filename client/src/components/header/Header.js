...
function Header(props) {
    const { gameId, user } = useContext(GameContext);
    ...
    return (
        <div className="Header">
            ...
            <div className="Header-game-id">{`${user}`}</div>
            {/* <div className="Header-controls">

                <div className="Header-share Header-control-item tooltip">
                    <i onClick={active ? undefined : handleStartClick } className={`Header-icon ${active ? 'Header-disabled': ''} fas fa-play`}></i>
